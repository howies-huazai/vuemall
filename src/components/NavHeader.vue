...
<!--        注册页面-->
        <div class="md-modal modal-msg md-modal-transition" v-bind:class="{'md-show':regisModalFlag}" >
        <div class="md-modal-inner">
          <div class="md-top">
            <div class="md-title">Register</div>
            <button class="md-close" @click="regisModalFlag=false">关闭</button>
          </div>
          <div class="md-content">
            <div class="confirm-tips">
              <div class="error-wrap">
                <span class="error error-show" v-show="errorTip">该用户名已被注册</span>
              </div>
              <ul>
                <li class="regi_form_input">
                  <i class="icon IconPeople"></i>
                  <input type="text"  class="regi_login_input regi_login_input_left"  v-model="username" placeholder="User Name">
                </li>
                <li class="regi_form_input noMargin">
                  <i class="icon IconPwd"></i>
                  <input type="password"  class="regi_login_input regi_login_input_left login-input-no input_text"  v-model="userpwd" placeholder="Password">
                </li>
              </ul>
            </div>
            <div class="login-wrap">
