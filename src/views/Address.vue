          ...
          <div class="checkout-addr">
            ...
            <div class="check-step">
              <ul>
                ...
                <li><span>确认您的</span>订单</li>
                <li><span>去</span>付款</li>
...
<!--                  添加新的地址按钮-->
                  <li class="addr-new" @click="addShow=true">
      ...
      <div class="md-modal modal-msg md-modal-transition" v-bind:class="{'md-show':addShow}">
        <div class="md-modal-inner">
          <div class="md-top">
            <div class="md-title">新增地址</div>
            <button class="md-close" @click="addShow=false">关闭</button>
          </div>
          <div class="md-content">
            <div class="confirm-tips">
              <div class="error-wrap">
                <span class="error error-show">地址已存在</span>
              </div>
              <ul>
                <li class="regi_form_input">
                  <i class="fa fa-user" style="position:absolute;left:10px;top: 13px;"></i>
                  <input type="text"  placeholder="name" tabindex="1" v-model="trueName" class="regi_login_input regi_login_input_left">
                </li>
                <li class="regi_form_input">
                  <i class="fa fa-map-marker" style="position:absolute;left:10px;top: 13px;"></i>
                  <input type="text"  placeholder="address" tabindex="2" v-model="trueAddress" class="regi_login_input regi_login_input_left">
                </li>
                <li class="regi_form_input">
                  <i class="fa fa-mobile-phone" style="position:absolute;left:10px;top: 13px;"></i>
                  <input type="text"  placeholder="tel" tabindex="3" v-model="trueTel" class="regi_login_input regi_login_input_left">
                </li>
              </ul>
            </div>
      ...
      methods:{
          ...
          addAddress(){
            axios.post("/users/addAddress",{
              ...
              trueAddress:this.trueAddress,
              trueTel:this.trueTel
            }).then((response)=>{
              let res = response.data;
              this.addShow=false;
